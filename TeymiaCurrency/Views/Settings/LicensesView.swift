    ...
    var body: some View {
        List {
            Section("licenses_section_attributions".localized) {
                ...
                LicenseRow(iconName: "Preview-AppIcon", attribution: "vecteezy.com", url: "https://www.vecteezy.com/png/13391079-cryptocurrency-exchange-3d-illustration", iconSize: 30)
            }
        }
